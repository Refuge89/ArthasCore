...
uint32 Spell::GetCCDelay(SpellInfo const* _spell)
{
    ...
    const uint32 delayForStuns           = 91;
    const uint32 delayForDisarms         = 85; // currently unused
    const uint32 delayForDisorients      = 95;
    const uint32 delayForFears           = 95;
    const uint32 delayForHorrors         = 91;
    const uint32 delayForOpenerStuns     = 95;
    const uint32 delayForScatters        = 95;
    const uint32 delayForBanishes        = 50;
    const uint32 NOdelayForInstantSpells = 70;
